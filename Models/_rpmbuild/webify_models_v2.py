...
# HBP 2015-06-01, Stefan Deser: Since we are using a Python version < 2.7 on the
#                               build server we monkey patch subprocess.check_output
#                               which is not available in Python < 2.7.
