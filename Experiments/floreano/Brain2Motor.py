...
"""
This module contains the transfer function which is responsible for determining the wheel speeds of the husky's movement,
based on the left and right wheel forward and backward neurons
"""
import hbp_nrp_cle.tf_framework as nrp
from hbp_nrp_cle.robotsim.RobotInterface import Topic
import gazebo_msgs.msg

#grabbing four fixed, but arbitrarily chosen befor initializing the learning, neurons as motor neurons
...
#adding the wheel speeds as a global variable to be used with the real wheel speed as an input
...
def Brain2Motor(t, ideal_wheel_speed, left_wheel_forward_neuron, left_wheel_back_neuron, right_wheel_forward_neuron, right_wheel_back_neuron):
    """
    The transfer function which calculates the wheel speeds of the husky robot based on the
